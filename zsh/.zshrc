...
plugins=(git vscode pip python virtualenv)
...
alias we="weather-command cli zip 27455 -i --am-pm"
alias wed="weather-command cli zip 27455 -i --am-pm -f daily"
alias weh="weather-command cli zip 27455 -i --am-pm -f hourly"
