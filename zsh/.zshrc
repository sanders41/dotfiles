...
plugins=(vi-mode zsh-syntax-highlighting zsh-autosuggestions web-search)
...
alias we="weather-command zip 27455"
alias wed="weather-command zip 27455 -f daily"
alias weh="weather-command zip 27455 -p -f hourly"
