...
---
--- `ts_ls`, aka `typescript-language-server`, is a Language Server Protocol implementation for
--- TypeScript wrapping `tsserver`. Note that `ts_ls` is not `tsserver`.
---
...
--- ### Monorepo support
---
--- `ts_ls` supports monorepos by default. It will automatically find the `tsconfig.json` or
--- `jsconfig.json` corresponding to the package you are working on. This works without the need
--- of spawning multiple instances of `ts_ls`, saving memory.
---
...
return {
  ...
  root_dir = function(bufnr, on_dir)
    ...
    -- FIX: Remove extra braces around root_markers to prevent triple-nesting
